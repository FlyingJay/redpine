    ...
    return (
      <SidePanel> 
        { this.props.is_opening
          ...
          : <ModalSection style={{paddingTop: '12vmin'}}>
              <ModalHeading style={{textAlign:'center'}}>Which of your acts will headline?</ModalHeading>
              <ModalSubheading style={{padding: '2vmin 0 0 0'}}>
                As the show's creator, you are the headliner. The headliner chooses the date, venue, and participating acts. You can change the headliner once your show has another act.
                <br/>
                <br/>
                <Link href={paths.infoHeadliner()} style={{fontWeight:'bold'}}>Learn how it pays to be a headliner</Link>
              </ModalSubheading>
            </ModalSection> }
        ...
        { this.props.user
          ...
          : <ActCreate
              ...
              onCreate={(act) => this.props.next(act)}/> }
      </SidePanel>
    )
  }
