...
export class InfoHeadliner extends React.PureComponent {
  constructor(props) {
    super(props) 
  }
        ...
        <MobileFirstDiv>
          <TotalLandingWrapper>
            ...
            <LandingInfoWrapper image="/Assets/images/background/bg12.jpg" mobileImage="/Assets/images/background/bg12.jpg">
              <InnerContentWrapper>
                <InnerContent>
                  <ContentMinorHeading>PLAY YOUR SHOW</ContentMinorHeading>
...
export default connect(mapStateToProps, mapDispatchToProps)(InfoHeadliner)
