...
export class SelectActRegister extends React.PureComponent {
  constructor(props){
    super(props)
    this.state = {
      first_name: '',
    ...
    return (
      <SidePanel> 
        <ModalSection style={{paddingTop: '12vmin'}}>
          <ModalHeading style={{textAlign:'center'}}>Wait, how will you stay in contact?</ModalHeading>
          <ModalSubheading style={{padding: '2vmin 0 0 0'}}>
            All shows organized on RedPine are coordinated through our Show Hub, an inclusive tool which brings the venue and show members together like never before!  
            <br/>
            <br/>
            We just need a few last bits of info to set up your account.
            <br/>
            After submitting this request, a RedPine account will allow you to create ticketing packages, organize tours, print guest lists, and track statistics for any show you play.      
          </ModalSubheading>
        </ModalSection>
        <ModalSection>
        ...
        <ModalSection style={{textAlign:'right'}}>
          {
            ...
            ? <PositiveButton onClick={() => this.props.register(this.state)}>
                Send Request&nbsp;&nbsp;
...
export default SelectActRegister
